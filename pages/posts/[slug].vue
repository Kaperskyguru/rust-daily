<template>
  ...
  <div class="flex grow flex-col gap-16">
    ...
    [&>*>*>code]:mt-5 [&>*>*>code]:rounded-xl [&>*>*>code]:bg-zinc-800
    [&>*>*>code]:p-4 [&>*>*>code]:text-sm [&>*>*>code]:font-medium
    [&>*>*>code]:text-zinc-100 [&>*>*>code]:overflow-x-auto
...
const { getPost } = await usePosts("/posts");
